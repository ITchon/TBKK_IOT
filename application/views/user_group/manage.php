												...
												foreach($result as $r){	  
												  ...
												  echo  
												   '<tr >
                            						...
                            						<td>
    											    <button type="button" value='.$r->sug_id.' class="btn btn-xs btn-default edit_form"><i class="fa fa-pencil"></i></button>
													<button type="button" value='.$r->sug_id.' class="btn btn-xs btn-default delete"><i class="fa fa-trash-o"></i></button>
													<button  type="button" value='.$r->sug_id.' class="btn btn-xs btn-warning rule">

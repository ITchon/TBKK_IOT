											...
											<tbody id="table">
    											...
    											'<tr>
    											    ...
    											    <td>'.$r->name.'</td>
													    ...
													    <td>
    											    <button type="button" value='.$r->spg_id.' class="btn btn-xs btn-default edit_form"><i class="fa fa-pencil"></i></button>
    											    <button type="button" value='.$r->spg_id.' class="btn btn-xs btn-default delete"><i class="fa fa-trash-o"></i></button>
                            						</td>    							 
												</tr>';
												$i++;	
													} 

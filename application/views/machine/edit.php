						...
						<div class="col-xs-2"></div>
							<div class="col-xs-8">
								...
								<div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
             		  			 ...
             		  			 <?php echo form_open('machine/save_edit', array('id'=>'smart-form-register', 'class'=>'form-horizontal'));?>	
									<div class="row">
									<div class="col-xs-12">
										<form class="form-horizontal hide" id="validation-form" method="get">
												...
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Machine name </label>
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="hidden" name="mach_id" value="<?php echo $result[0]->machine_id ?>"/>
																		<input type="text" name="mach_name" placeholder="Machine name" value="<?php echo $result[0]->machine_name ?>" class="width-100" autofocus required/>
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Machine No </label>
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="text" name="mach_no" placeholder="Machine No." value="<?php echo $result[0]->machine_no ?>" class="width-100" autofocus required/>
